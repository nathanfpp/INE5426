// FunÃ§Ã£o retornando tipo errado : a(0) Ã© detectado como variÃ¡vei "a"
...
class Nodo {
    public:
	atributo_nodo vazio; //garante que o programa nÃ£o dÃª pau
        Tipo tipo;
        std::string id;
        int inteiro;
        double real;
...
class Variavel : public Nodo {
    public:
        Tipo tipoDeVariavel;
	int ponteiros;  //0 nao Ã© referenciado, > 1 n referencias
